...
class QuizNextResponseTest {
    ...
    class BlankCountMapping {
        ...
        void counts_one_slot_when_blank_has_synonyms() {
            ...
            QuizNextResponse response = QuizNextResponse.from(quiz, 1L, 5);
        ...
        void returns_null_for_non_keyword_blank_quizzes() {
            ...
            assertThat(QuizNextResponse.from(oxQuiz, 1L, 5).blankCount()).isNull();
            assertThat(QuizNextResponse.from(multipleChoiceQuiz, 1L, 5).blankCount())
                    .isNull();
        }
    }
