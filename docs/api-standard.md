...
| prod | `http://localhost:3000`, `https://thumbsup-app.vercel.app`, `https://*-thumbsup.vercel.app`, `https://authoring-thumbsup.vercel.app`, `https://thumbsup-authoring-*-thumbsup.vercel.app` | 로컬 FE, 사용자·저작 Vercel main 배포 및 PR preview → 운영 서버 |
