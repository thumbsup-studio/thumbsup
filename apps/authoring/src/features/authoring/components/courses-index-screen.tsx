...
import { Card } from "@thumbsup/ui-web/card";
import { Chip } from "@thumbsup/ui-web/chip";
import { EmptyState } from "@thumbsup/ui-web/empty-state";
import { Feedback } from "@thumbsup/ui-web/feedback";
import { Skeleton } from "@thumbsup/ui-web/skeleton";
    ...
    <ul className="flex flex-col gap-3">
      {state.courses.map((course) => (
        <li key={course.courseId}>
          <Link className="block" href={`/quizzes/${course.courseId}`}>
